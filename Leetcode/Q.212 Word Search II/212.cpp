/*//
//  In this question we implement a trie and do dfs on the matrix.
//  The trie can be built in conventional way, and after we push the words into the trie, do dfs for each grid and find if there are existing words.
//*/
